...
#ifndef ESP32_C3_FastTimerInterrupt_h
#define ESP32_C3_FastTimerInterrupt_h
  ...
  public:
    ...
    bool setFrequency(float frequency, c3_timer_callback callback)
    {
      ...
      {      
        ...
        ISR_SERVO_LOGERROR3(F("ESP32_C3_FastTimerInterrupt: _timerNo ="), _timerNo, F(", _fre ="), TIMER_BASE_CLK / TIMER_DIVIDER);
...
#endif      // ESP32_C3_FastTimerInterrupt_h
